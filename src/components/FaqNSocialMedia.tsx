...
// const Hover = lazy(() => import("../assets/Hover&Pressed.svg?react"));
// const Neutra1 = lazy(() => import("../assets/Neutral-1.svg?react"));
// const Neutra2 = lazy(() => import("../assets/Neutral-2.svg?react"));
// const Neutra = lazy(() => import("../assets/Neutral.svg?react"));
...
import hoverImage from "../assets/Hover&Pressed.svg";
import neutra1Image from "../assets/Neutral-1.svg";
import neutra2Image from "../assets/Neutral-2.svg";
import neutraImage from "../assets/Neutral.svg";
import arrowRightIcon from "../assets/Vector.svg";
                ...
                <div className="relative">
                    ...
                    <div className='flex justify-center items-center gap-6 mt-[32px]'>
                        <p className='w-[48px] h-[48px] rounded-[40px] border p-3 border-[#EdEEEE] flex justify-center items-center'>
                            <img src={arrowLeftIcon} alt="Previous" className="w-4 h-4" />
                        </p>
                        <p className='w-[48px] h-[48px] rounded-[40px] border p-3 border-[#EdEEEE] flex justify-center items-center'>
                            <img src={arrowRightIcon} alt="Next" className="w-4 h-4" />
                        </p>
                    </div>
                </div>
            </div>
