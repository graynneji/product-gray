...
// const Payment = lazy(() => import('../assets/Payment.svg?react'));
// const One = lazy(() => import("../assets/1.svg?react"));
// const Alert = lazy(() => import("../assets/Alert.svg?react"));
// const ShoppingCart = lazy(() => import("../assets/shoppingBagCart.svg?react"));
...
import oneImage from "../assets/1.svg";
import alertIcon from "../assets/Alert.svg";
import shoppingCartIcon from "../assets/shoppingBagCart.svg";
    ...
    return (
        <div className="grid grid-cols-1 w-full font-serif mx-auto px-[135px] py-[72px] lg:grid-cols-2 gap-[62px]">
            ...
            <div className="space-y-8">
                {/* Header */}
                <div>
                    <div className="flex items-center gap-2 font-dm-sans  text-[16px] leading-[150%]">
                        <img src={alertIcon} alt="Alert" className="w-4 h-4" />
                        <span className='text-[#25549E]'>Selling fast! 5 people have this in their carts.</span>
                    </div>
                    <h1 className="text-[38px] text-start text-primary mb-4">
                        Personalized Photo and Slogan Text Hoodie
                    </h1>
                ...
                <div className='flex flex-col gap-4 font-sans text-[16px] leading-[150%] text-primary'>
                    <h3 className="font-bold">Perfect to</h3>
                    <div className="flex items-center gap-2">
                        <Star className="w-4 h-4 text-[#25549E]" />
                        <span>Dress yourself up</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Gift className="w-4 h-4 text-[#25549E]" />
                        <span>Anniversary gifts for your loved one</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Heart className="w-4 h-4 text-[#25549E]" />
                        <span>Birthday or celebration gifts for friends and family</span>
                    </div>
                </div>
                ...
                <div className="flex justify-center items-center flex-col gap-4">
                    ...
                    <img src={paymentImage} alt="Payment methods" className="w-auto h-auto max-w-full" />
                </div>
            </div>
        </div>
    );
